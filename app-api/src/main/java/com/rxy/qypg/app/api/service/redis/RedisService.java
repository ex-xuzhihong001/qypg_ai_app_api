package com.rxy.qypg.app.api.service.redis;
...
public interface RedisService {
    ...
    Set<ZSetOperations.TypedTuple<Object>> zReverseRangeByScoreWithScores(String key, double min, double max, long start, long end);
